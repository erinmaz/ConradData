...
outdir_dentate_R=${MAINDIR}/analysis/${MYSUB}/diffusion/Kwon_ROIs/dentate_R_dil_thalwaypoint
outdir_dentate_L=${MAINDIR}/analysis/${MYSUB}/diffusion/Kwon_ROIs/dentate_L_dil_thalwaypoint
...
echo ${MAINDIR}/analysis/${MYSUB}/diffusion/Kwon_ROIs/Precentral+Juxtapositional_L >> ${outdir_dentate_R}/waypoints.txt
...
echo ${MAINDIR}/analysis/${MYSUB}/diffusion/Kwon_ROIs/Precentral+Juxtapositional_R >> ${outdir_dentate_L}/waypoints.txt
